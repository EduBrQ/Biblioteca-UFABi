...
<script>
  import TrabalhosDeConclusaoService from '../../services/trabalhosConclusaoService'
  ...
  export default {
    ...
    methods: {
      ...
      getAllAlunos() {
        TrabalhosDeConclusaoService.getAll().then(data => {
      ...
      getAlunoById(id) {
        TrabalhosDeConclusaoService.getById(id).then(data => {
      ...
      saveAluno() {
        if (this.alunoCreate.id != null) {
          ...
          TrabalhosDeConclusaoService.edit(this.alunoCreate).then(data => {
          ...
          TrabalhosDeConclusaoService.create(this.alunoCreate).then(data => {
      ...
      deleteAluno(id) {
        TrabalhosDeConclusaoService.delete(id).then(data => {
          this.alunos = []
          this.getAllAlunos()
        }).catch(e => {
          console.log(e)
