...
/**
 * Class Revistas: Atribui os diversos dados referentes aos Trabalhos de Conclusao.
 * 
 * @author Lucas Nunes, Lanmark Rafael, Higor Pereira
 * 
 * @param Titulo; Edicao; Autores; Orientadores; Local; ID; Ano da Defesa; Tipo de TCC;
 * 
