...
//    }
    /**
     * Metodo de implementa��o para uma �nica SessionFactory do Hibernate. 
     * Vincula uma Sess�o do Hibernate da factory especificada, 
    ...
    /**
     * � uma FactoryBean <SessionFactory>. 
     * Cria uma inst�ncia SessionFactory local.
    ...
    public LocalSessionFactoryBean hibernate5SessionFactoryBean(){
        ...
        /**
         * Define as propriedades de conversa��o entre o hibernate e uma fonte de dados.
         * 
         */
